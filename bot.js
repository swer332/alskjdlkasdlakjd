...
setInterval(() => {
  http.get(`http://lskjflksf.glitch.me/`);
}, 280000);
...
client.on('message' , message => {
 ...
 let array_of_mentions = message.mentions.users.array();
  ...
  if (array_of_mentions.length == 1 || array_of_mentions.length == 2) {
    ...
    message.channel.send(`xo منشن الذي تريد لعب معه`)
...
🎮 - ${prefix}fast ll كتابة الكلمة بسرعه

🎮 - ${prefix}math ll رياضيات

🎮 - ${prefix}puzzle ll لغز

🎮 - ${prefix}xo ll اكس او

🎮 - ${prefix}rps ll حجرة,ورقة,مقص

🎮 - ${prefix}top ll قائمة النقاط

🎮 - ${prefix}bot ll معلومات
---------------------------------**`)
.setFooter('https://discord.gg/bmWe9tt')
